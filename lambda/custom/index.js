...
const languageString = {
    en: {
        translation: {
            ...
            GAME_NAME: 'Quantum AWS Cert Quiz',
            HELP_MESSAGE: 'I will ask you %s multiple choice questions. Respond with the number of the answer. For example, say one, two, three, or four.',
            ...
            WELCOME_MESSAGE: 'I will ask you %s questions. Say the number of your answer, ',
